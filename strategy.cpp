...
const double comp_time = 160;
const double shop_hour = 31 * 4 * 3;
...
vector<double> p_arch; 		// probability of archtype
...
int main() {
	...
	iterate(0, comp_time, shop_hour, comp_time, comp_time);
	
	cout << "Best Average Alliance Score:  " << ma << endl;
